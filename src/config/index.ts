...
export const BASE_URL = isMainnet ? 'https://cowswap.app' : 'https://testnet.cowswap.app'
export const BASE_EXCHANGE_URL = isMainnet ? 'https://exchange.cowswap.app' : 'https://exchange-testnet.cowswap.app'
...
export const NFT_URI = process.env.REACT_APP_NFT_URI