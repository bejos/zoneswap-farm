...
const config: MenuEntry[] = [
  ...
  // },
  {
    ...
    items: [
      {
        label: 'Exchange',
        href: isMainnet ? 'https://exchange.cowswap.app/#/swap' : 'https://exchange-testnet.cowswap.app/#/swap',
      },
      {
        label: 'Liquidity',
        href: isMainnet ? 'https://exchange.cowswap.app/#/pool' : 'https://exchange-testnet.cowswap.app/#/pool',
      },
    ],
  },
  {
